...
class SupabaseService {
  ...
  static const String supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRzeXZwamhwb2d4bXFjcGVhb3diIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTY2ODE1MjgsImV4cCI6MjAzMjI1NzUyOH0.30rbkShbpM_h06pZIAw39Ma2SC0thZi9WiV__lhh4Lk';
  ...
  static String findLatestBackupFile(List<FileObject> files) {
    final backupFiles = files
        .where((file) => file.name.startsWith('backup_') && file.name.endsWith('.zip'))
        .toList();
  ...
  static Future<Uint8List> downloadFile(String institutionName, String fileName) async {
    try {
